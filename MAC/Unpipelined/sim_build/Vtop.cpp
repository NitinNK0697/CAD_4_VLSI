...
void Vtop::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/shakti/Desktop/Unpipelined/verilog/mk_mac.v", 43, "",
...
VL_INLINE_OPT void Vtop::_sequent__TOP__4(Vtop__Syms* __restrict vlSymsp) {
    ...
    // Body
    if (vlTOPp->RST_N) {
        if (vlTOPp->mk_mac__DOT__bfloat_out_r_EN) {
            vlTOPp->mk_mac__DOT__bfloat_out_r = vlTOPp->mk_mac__DOT__bfloat_out_r_D_IN;
        }
    } else {
        vlTOPp->mk_mac__DOT__bfloat_out_r = 0U;
    }
    if (vlTOPp->RST_N) {
